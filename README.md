...
Your comments, suggestions, new feature requests and bug reports are welcome and can be made in the [Issues](https://github.com/revobricks/studio/issues) section. However, please take into account that reported issues will be processed by the Revobricks team according to the best effort principle, so adjust your expectations accordingly. However, if you want a more prompt and high-quality response as well as direct contact with technical support.
...
-   [FAQ](https://github.com/revobricks/studio/wiki/Q&A)
...
![DC-RAD Project](https://github.com/eez-open/studio/blob/master/docs/images/projects_intro.png)
...
![Flow](https://github.com/eez-open/studio/blob/master/docs/images/flow_intro.png)

### DC-RAD _Instrument_

![DC-RAD Instrument](https://github.com/eez-open/studio/blob/master/docs/images/instruments_intro.png)
...
```
git clone https://github.com/revobricks/studio
cd studio
npm install
npm run build
```
...
The USB TMC driver must be installed if you want to access the T&M instrument using the USB-TMC interface from DC-RAD _Instrument_ section.

### Windows

Download and start [Zadig](http://zadig.akeo.ie/). Select your device, select libusb-win32 and press "Replace Driver" button:

![Zadig](https://github.com/eez-open/studio/blob/master/docs/images/usbtmc_zadin_windows.png)
...
The default created database as well as its location can be changed later through the options in the _Settings_ section of DC-RAD.
