...
Your comments, suggestions, new feature requests and bug reports are welcome and can be made in the [Issues](https://github.com/revobricks/studio/issues) section. However, please take into account that reported issues will be processed by the Revobricks team according to the best effort principle, so adjust your expectations accordingly.

### Ownership and License

The contributors are listed in CONTRIB.TXT. This project uses the GPL v3 license, see LICENSE.TXT.
DC-RAD uses the [C4.1 (Collective Code Construction Contract)](http://rfc.zeromq.org/spec:22) process for contributions.
To report an issue, use the [DC-RAD issue tracker](https://github.com/revobricks/studio/issues).

### Links

-   [Web page](https://revobricks.com/)
-   [FAQ](https://github.com/eez-open/studio/wiki/Q&A)

## Introduction

DC-RAD is a free and open source cross-platform low-code visual tool for desktop and embedded GUIs with [LVGL](https://lvgl.io/) support. Built-in _EEZ Flow_ enables the creation of complex scenarios for test and measurement automation, and the Instruments feature offers remote control of multiple devices and T&M equipment including [EEZ BB3](https://github.com/eez-open/modular-psu) T&M chassis and [EEZ H24005](https://github.com/eez-open/psu-hw) programmable power supply and any other T&M devices that support [SCPI](https://www.ivifoundation.org/scpi/) from manufacturers such as Keysight, Rigol, Siglent, etc.
...
-   Direct import of **DC-RAD** generated IDFs and **Keysight’s Offline Command Expert command** sets
...
Download and start `DC_RAD_setup.exe`.

### Nix

The Nix flake provides a derivation for DC-RAD or an overlay
...
You will probably need to add your Linux account to the usbtmc group before you can access the instrument using DC-RAD. Connect your instrument with a USB cable and turn it on. Wait until booting is complete. Now check the instrument group name by entering the following command:
